...
![Retrieve, organize and clean-up ﬁles used by the Endpoint Protector Server](/images/endpointprotector/2509/admin/systemmaintenance/filemaintenance.webp)
...
![View the list of exported entities, download or delete them, and view the scheduled export in the system and reschedule them accordingly](/images/endpointprotector/2509/admin/systemmaintenance/listofentities.webp)
...
![Initiate the manual generation of the scheduled export from the Device Control](/images/endpointprotector/2509/admin/systemmaintenance/listofdevices.webp)

![Manual generation of the scheduled export from the Device Control](/images/endpointprotector/2509/admin/systemmaintenance/dcscheduleexport.webp)
...
![The System Snapshots module allows you to save all device control rights and settings in the system and restore them later if needed](/images/endpointprotector/2509/admin/systemmaintenance/systemsnapshots.webp)
...
![Restore a previously created snapshot](/images/endpointprotector/2509/admin/systemmaintenance/restoresnapshot.webp)
...
![Allows old logs to be saved and exported](/images/endpointprotector/2509/admin/systemmaintenance/auditlogbackup.webp)
...
![Audit Log Backup Scheduler](/images/endpointprotector/2509/admin/systemmaintenance/scheduledbackup.webp)
...
![Externalize ﬁles generated by Endpoint Protector to a particular storage disk from the network](/images/endpointprotector/2509/admin/systemmaintenance/externalstorage.webp)
...
![Conﬁgure an FTP Server](/images/endpointprotector/2509/admin/systemmaintenance/ftpserver.webp)
...
![Conﬁgure an SFTP Server](/images/endpointprotector/2509/admin/systemmaintenance/sftpserver.webp)
...
![Conﬁgure a Samba / Network Share Server](/images/endpointprotector/2509/admin/systemmaintenance/sambastorage.webp)
