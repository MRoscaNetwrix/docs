...
[Client Software](/docs/endpointprotector/2509/admin/systemconfiguration/overview.md#client-software) topic.
...
**Step 1 –** Navigate to the [Denylists and Allowlists](/docs/endpointprotector/2509/admin/denylistsallowlists/overview.md)
