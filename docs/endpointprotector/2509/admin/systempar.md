...
from Device Control, Global Settings, [Device Control](/docs/endpointprotector/2509/admin/dc_module/dcmodule.md).
...
[Device Control](/docs/endpointprotector/2509/admin/dc_module/dcmodule.md) topic and then select the **customized notiﬁcation**
...
**Step 4 –** Navigate to [Device Control](/docs/endpointprotector/2509/admin/dc_module/dcmodule.md), Device Types section and
