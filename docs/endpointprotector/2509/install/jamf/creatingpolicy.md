...
![Creating a New Policy](/images/endpointprotector/2509/install/agent/jamf/policies.webp)
...
![Configuring information on new policy](/images/endpointprotector/2509/install/agent/jamf/newpolicy.webp)
...
![Configuring Script under Policies](/images/endpointprotector/2509/install/agent/jamf/scripts.webp)

**Step 4 –** On the Packages section, click **Configure** and then add the package
EndpointProtector.pkg.

![Adding the Endpoint Protector package to policy](/images/endpointprotector/2509/install/agent/jamf/addingpackage.webp)
...
![Adding Devices and users to apply to the scope](/images/endpointprotector/2509/install/agent/jamf/policyscope.webp)
